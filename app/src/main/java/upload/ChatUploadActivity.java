...
public class ChatUploadActivity extends Activity {
	...
	private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
		...
		private String uploadFile() {
			...
			HttpPost httppost = new HttpPost(Config.FILE_CHAT_UPLOAD_URL);
	...
	private void showAlert(String result) {
		...
		String ChatThumbName = null;
		try {
			JSONObject json = new JSONObject(result);
			ChatImageName = json.getString("ImageName");
			ChatThumbName = json.getString("ThumbsName");
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

		user.ChatImageName = IFY.IMAGE_URL + ChatImageName;
		user.ChatThumbName = IFY.IMAGE_URL + ChatThumbName;
		
		ify.currUser.sendNewMessage("Photo notification", user, true);
